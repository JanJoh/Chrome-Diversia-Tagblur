...
<img src="docs/installningar-v3.png" alt="Inställningspanelen" width="384">
...
- **Kontrollera miniatyrer i bakgrunden** (på som standard): hämtar taggarna för
  miniatyrer du ser, försiktigt och med pauser. Läs [Bakgrundskontroller och
  skydd mot skrapning](#bakgrundskontroller-och-skydd-mot-skrapning) innan du bestämmer dig.
...
## Bakgrundskontroller och skydd mot skrapning

Översiktssidor (flödet, gallerier, sidopanelen) visar inte bildernas taggar. För att veta
om en miniatyr ska suddas ut måste tillägget hämta bildens taggar från sajten, ungefär
som när du själv klickar på en miniatyr. Det görs försiktigt:

- **Bara miniatyrer du ser** (eller som är nära att synas) kontrolleras. Flikar i
  bakgrunden gör inga anrop förrän du tittar på dem.
- **En i taget** för alla diversia-flikar tillsammans, med en **slumpad paus på 1,5–4
  sekunder** mellan varje, och **högst 20 per minut**.
- Den lätta förfrågan som sajtens egen bildväxlare använder (`/g.php`, cirka 35 kB)
  används i stället för hela bildsidan (cirka 130 kB) när det går.
- **Om sajten svarar oväntat** (fel, inloggningssida, spärr) **pausas alla kontroller i 15
  minuter.** Panelen visar pausen och har en knapp för att återuppta.

Sajter kan ändå ha skydd mot automatiserad trafik, och ingen takt är osynlig. Att använda
bakgrundskontroller sker **på egen risk**, och det kan strida mot sajtens regler.

> **Vill du inte riskera att utlösa skydd mot skrapning:** stäng av **Kontrollera
> miniatyrer i bakgrunden**. Då gör tillägget inga anrop i bakgrunden alls, men det
> betyder att **alla foton på översiktssidor kan visas utsuddade**: okontrollerade
> miniatyrer förblir utsuddade (med *Sudda ut bilder tills de har kontrollerats* på),
> och bara bilder du själv öppnar kontrolleras. Samma sak gäller under en paus.
> Stänger du även av den inställningen visas okontrollerade miniatyrer i stället som
> vanligt, utan filtrering.
...
| Taggar via bildväxlaren | `/g.php?a=…&id=…`; action-ordet läses från sajtens `getpic()` på bildsidor. Fungerar det inte används hela bildsidan. |

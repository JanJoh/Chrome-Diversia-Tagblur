...
const DTB_STRINGS = {
  sv: {
    ...
    lookupsHint: "Hämtar taggar för synliga miniatyrer från sajten. Av: inga bakgrundsanrop, men okontrollerade miniatyrer förblir utsuddade.",
    lookupPaused: "Bakgrundskontroller pausade till {time}: sajten svarade oväntat.",
    resume: "Återuppta",
    blurPx: "Oskärpa (px)",
    updateCheck: "Sök efter nya versioner",
    updateCheckHint: "Frågar GitHub en gång per dygn, när panelen öppnas, vilken den senaste versionen är. Det är tilläggets enda anrop till något annat än diversia.social; inget om dig skickas med.",
    updateAvailable: "Version {version} finns att hämta.",
  ...
  en: {
    ...
    lookupsHint: "Fetches tags for visible thumbnails from the site. Off: no background requests, but unchecked thumbnails stay blurred.",
    ...
    updateCheckHint: "Asks GitHub once a day, when the panel is opened, what the latest version is. It is the extension's only request to anything other than diversia.social, and sends nothing about you.",

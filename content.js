(() => {
  ...
  // Background lookups are paced to look like a person clicking around, and
  // are shared by every diversia tab (see withLookupSlot): one at a time, a
  // random pause between them, a per-minute cap, and a full stop for a while
  // if the site answers with anything unexpected.
